...
int main(int argc, char **argv)
{
    ...
    btrblocks::files::writeDirectory(relation, FLAGS_btr, FLAGS_stats, FLAGS_compressionout,
      typefilter, FLAGS_column, FLAGS_chunk, FLAGS_verify, binary_creation_time);
    return 0;
}
